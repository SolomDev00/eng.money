    ...
    <footer className="bg-white dark:bg-[#333] h-[17vh] max-sm:max-h-[21vh] max-sm:min-h-[21vh] xl:h-[15.5vh]">
      <div className="container">
        <div className="flex flex-row items-center justify-center mb-5 pt-5">
          ...
          >
            <img
              className="w-16 max-sm:w-12 hidden dark:block"
              src={logo}
              alt="logo"
            />
            <img
              className="w-16 max-sm:w-12 dark:hidden"
              src={logoDark}
              alt="logo"
            />
            {i18.language === "en" ? (
              <span className="text-2xl en max-sm:text-lg max-sm:w-[200px]">
              ...
              <span className="text-2xl ar max-sm:text-lg">
