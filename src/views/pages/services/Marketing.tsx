...
const MarketingPage = () => {
  ...
  return (
    <div className="flex flex-col justify-between items-stretch gap-y-[7.4rem]">
      <section
        id="marketing"
        className={`container flex flex-col gap-12 justify-between items-center pt-48 pb-12 text-center bg-marketing`}
