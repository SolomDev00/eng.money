      ...
      <div className="space-y-36 z-30">
        <div className="flex flex-col justify-center items-center text-center space-y-12 max-sm:space-y-4">
          ...
          <Link to={"/register"}>
            <Button
              variant={"outline"}
              className="flex flex-row gap-2 py-2 px-6 rounded-md text-lg text-[#333] dark:text-white hover:bg-[#dc6d31] border-[#dc6d31] border-2 max-sm:px-3 max-sm:text-base"
            >
              {t("signal.seeMore")}
